...
keyboard.keymap = [
    [
        ...
        KC.LCTL,  KC.LALT,  KC.LWIN,  XXX,      XXX,      XXX,      XXX,      XXX,      KC.SPACE,
            XXX,      KC.RWIN,  KC.RALT,  KC.RCTL,  KC.MO(2), KC.LEFT,  KC.DOWN,  KC.RIGHT,
    ],
    [
    ...
    [
        ...
        KC.CAPS,  ________, ________, ________, ________, ________, ________, ________, ________, 
            KC.TO(1), ________, ________, ________, ________, ________, ________, ________,
        ________, ________, ________, ________, ________, ________, ________, ________, KC.TO(0),
